 ...
 *
 * There are no endpoints yet -- this carries the redirects and the robots policy that any
 * host answering on a domain has to have, and is the place real endpoints will land.
 */
const app = new Hono();
