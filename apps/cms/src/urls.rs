...
pub const SOURCE: &str = "https://github.com/canmi21/workspace";
pub const INTERNAL_APP: &str = "https://canmi.app";
pub const INTERNAL_INFRA: &str = "https://ffoni.com";
pub const INTERNAL_LINK: &str = "https://ill.li";
...
pub const EXTERNAL_INSIGHTS: &str = "https://static.cloudflareinsights.com/beacon.min.js";
pub const EXTERNAL_FEEDSMITH: &str = "https://feedsmith.dev";
pub const EXTERNAL_SOCIAL_TELEGRAM: &str = "https://t.me";
pub const EXTERNAL_SOCIAL_X: &str = "https://x.com";
