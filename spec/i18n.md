...
No em dash, en dash or fullwidth dash in a title or a subtitle, long or short, unless the source
field already carries one. A hyphen is untouched: it builds words rather than splicing
...
The check reads the field's own source: a subtitle answers to the subtitle, not to the title
above it.
