...
past any threshold. Six segments in the corpus are reported, all of them terse Chinese sources
whose translations say noticeably more -- which is the judgement this hands to a person, not a
verdict it reaches itself.
...
flag on a segment is the whole intent -- it is read by a person, who then reads all eight.
