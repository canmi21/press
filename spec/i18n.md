...
### A heading is also a label, and the rail is narrow

Body headings become navigation labels in the article table of contents, and a translated one
...
**Three bands, and only the last is refused.** Under one line is the target. Two lines are a
