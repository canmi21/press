...
[styling.md](styling.md) describes: one picture with one reading, instead of a dozen labels in
draw order. A quadrant already had the shape and takes the description in place of the sentences
it used to assemble. A feed reader gets it in place of `[Diagram: <the article's
